...
This web api is used to store quiz questions across multiple categories and create a quiz out of existing questions
...
6. [x] Create a GET endpoint to get questions based on category.
7. [x] Create a GET endpoint to get questions based on a search term. It should return any questions for whom the search term is a substring of the question.
